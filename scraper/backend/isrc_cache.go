...
// GetCachedISRC returns the cached ISRC for the given Spotify track ID, or "" if not cached.
...
// PutCachedISRC stores an ISRC for the given Spotify track ID in the persistent cache.
